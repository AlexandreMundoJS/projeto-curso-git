...
public class RecyclerView_ListaEmpresa extends RecyclerView.Adapter<RecyclerView_ListaEmpresa.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.database_lista_empresa_conteudo_recyclerview, parent, false);
    ...
    public int getItemCount() {
        // Tamanho de itens armazenados em empresas
